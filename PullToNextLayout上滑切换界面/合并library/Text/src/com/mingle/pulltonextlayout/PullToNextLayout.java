...
public class PullToNextLayout extends FrameLayout {
	...
	// public PullToNextLayout(Context context, AttributeSet attrs, int
    ...
    /**
     * 灏唒ullToNextView 娣诲姞鍒� PullToNextLayout 鎺т欢涓�
     *
     * @param index
