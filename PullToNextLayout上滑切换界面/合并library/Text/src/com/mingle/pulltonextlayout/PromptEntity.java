...
public class PromptEntity {
	...
	public PromptEntity(Context context) {
		...
		setPullDownToPreviousPtn(context
				.getString(R.string.ptn_pull_down_to_previous));
		...
		setReleaseToPreviousPtn(context
				.getString(R.string.ptn_release_to_previous));
		setTheFirstPtn(context.getString(R.string.ptn_the_first));
	}

	public PromptEntity(String noMoreDatePtn, String releaseToNextPtn,
			String pullUpToNextPtn, String theFirstPtn,
			String releaseToPreviousPtn, String pullDownToPreviousPtn) {
